...
export type OrderStatus = "placed" | "progress" | "pending" | "delivery" | "delivered";
...
export default function OrderCard({
  name, contact, order, deliveryDate, status,
}: {
  name: string; contact: string; order: string; deliveryDate: string; status: OrderStatus;
}) {
  return (
    <div className="bg-white rounded-2xl border border-gray-200/70 p-4 shadow-[0_1px_0_rgba(0,0,0,0.02)]">
      ...
      <div className="mt-2 space-y-1 text-sm text-gray-600">
        ...
        <p><span className="font-medium">Order:</span> {order}</p>
